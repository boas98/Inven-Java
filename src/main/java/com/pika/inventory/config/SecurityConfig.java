 ...
 */
package com.pika.inventory.config;
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth)
        throws Exception{
            ...
            protected void configure(HttpSecurity http) throws Exception {
                http
                        .authorizeRequests()
//                            .antMatchers(HttpMethod.GET,"/api/barang/**").hasRole("BARANG_VIEW")
//                            .antMatchers(HttpMethod.POST,"/api/barang/**").hasRole("BARANG_CREATE")
//                            .antMatchers(HttpMethod.DELETE,"/api/barang/**").hasRole("BARANG_DELETE")
//                            .antMatchers(HttpMethod.PUT,"/api/barang/**").hasRole("BARANG_UPDATE")
